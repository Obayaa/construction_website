...
function Navbar() {
    ...
    return (
        <nav className="w-full bg-gradient-to-r from-blue-600 via-blue-900 to-blue-600 shadow-lg sticky top-0 z-50 backdrop-blur-sm">
                ...
                <div className="px-4 pt-2 pb-4 space-y-2">
                    {navItems.map((item) => (
                        <a
                            key={item.href}
                            href={item.href}
                            className="block text-white font-medium text-lg hover:text-orange-400 hover:bg-blue-800/50 px-3 py-2 rounded-md transition-all duration-200"
